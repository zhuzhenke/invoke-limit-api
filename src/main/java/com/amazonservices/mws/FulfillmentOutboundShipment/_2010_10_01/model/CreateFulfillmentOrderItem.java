...
public class CreateFulfillmentOrderItem extends AbstractMwsObject {
    ...
    /** Value constructor. */
    public CreateFulfillmentOrderItem(String sellerSKU,String sellerFulfillmentOrderItemId,int quantity,String giftMessage,String displayableComment,String fulfillmentNetworkSKU,String orderItemDisposition,Currency perUnitDeclaredValue,Currency perUnitPrice,Currency perUnitTax) {
        this.sellerSKU = sellerSKU;
        this.sellerFulfillmentOrderItemId = sellerFulfillmentOrderItemId;
        this.quantity = quantity;
        this.giftMessage = giftMessage;
