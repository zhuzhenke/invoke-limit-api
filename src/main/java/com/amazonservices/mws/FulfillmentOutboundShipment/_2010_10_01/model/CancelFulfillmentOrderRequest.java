...
public class CancelFulfillmentOrderRequest extends AbstractMwsObject implements AmazonBaseRequest{
    ...
    /** Value constructor. */
    public CancelFulfillmentOrderRequest(String sellerId,String mwsAuthToken,String marketplace,String sellerFulfillmentOrderId) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplace = marketplace;
        this.sellerFulfillmentOrderId = sellerFulfillmentOrderId;
    ...
    public CancelFulfillmentOrderRequest(String sellerId,String marketplace,String sellerFulfillmentOrderId) {
        this.sellerId = sellerId;
        this.marketplace = marketplace;
        this.sellerFulfillmentOrderId = sellerFulfillmentOrderId;
    }
