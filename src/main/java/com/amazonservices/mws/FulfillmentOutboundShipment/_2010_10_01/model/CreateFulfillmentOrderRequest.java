...
public class CreateFulfillmentOrderRequest extends AbstractMwsObject implements AmazonBaseRequest {
    ...
    /** Value constructor. */
    public CreateFulfillmentOrderRequest(String sellerId,String mwsAuthToken,String marketplace,String marketplaceId,String sellerFulfillmentOrderId,String displayableOrderId,XMLGregorianCalendar displayableOrderDateTime,String displayableOrderComment,String shippingSpeedCategory,DeliveryWindow deliveryWindow,Address destinationAddress,String fulfillmentAction,String fulfillmentPolicy,String fulfillmentMethod,CODSettings codSettings,String shipFromCountryCode,NotificationEmailList notificationEmailList,CreateFulfillmentOrderItemList items) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.marketplace = marketplace;
        this.marketplaceId = marketplaceId;
    ...
    public CreateFulfillmentOrderRequest(String sellerId,String marketplace,String marketplaceId,String sellerFulfillmentOrderId,String displayableOrderId,XMLGregorianCalendar displayableOrderDateTime,String displayableOrderComment,String shippingSpeedCategory,DeliveryWindow deliveryWindow,Address destinationAddress,String fulfillmentAction,String fulfillmentPolicy,String fulfillmentMethod,CODSettings codSettings,String shipFromCountryCode,NotificationEmailList notificationEmailList,CreateFulfillmentOrderItemList items) {
        this.sellerId = sellerId;
        this.marketplace = marketplace;
        this.marketplaceId = marketplaceId;
        this.sellerFulfillmentOrderId = sellerFulfillmentOrderId;
