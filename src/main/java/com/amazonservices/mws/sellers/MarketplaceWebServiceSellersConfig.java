...
public class MarketplaceWebServiceSellersConfig {
    ...
    public MarketplaceWebServiceSellersConfig withServiceURL(String aserviceUrl) {
    ...
    public MarketplaceWebServiceSellersConfig withMaxAsyncQueueSize(int size) {
        cc.setMaxAsyncQueueSize(size);
        return this;
    }
    ...
    public MarketplaceWebServiceSellersConfig withMaxAsyncThreads(int threads) {
        cc.setMaxAsyncThreads(threads);
        return this;
    }
