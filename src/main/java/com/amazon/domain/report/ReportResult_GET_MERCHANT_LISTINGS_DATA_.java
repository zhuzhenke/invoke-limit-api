 ...
 * @date 2018/03/26
 */
public class ReportResult_GET_MERCHANT_LISTINGS_DATA_ implements ResolveReportResult {
    ...
    public List<Object> resolveResult(List<String> resultList) {
        ...
        for (int i = 1; i < resultList.size(); i++) {
            ...
            ReportResult_GET_MERCHANT_LISTINGS_DATA_ object = new ReportResult_GET_MERCHANT_LISTINGS_DATA_();
            ...
            object.setFulfillmentChannel(strings[26]);
            object.setMerchantShippingGroup(strings[27]);
